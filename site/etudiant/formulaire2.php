  ...
  <div id="section" style="margin: auto;">
    <div id="test">
      ...
      <div class="encadrer">
       ...
       <div class="encadrer" style="width: 60%;">
        <p> - Plus une option possède de points, plus vous aurez de chance d'y être affecté.</p>
        <p> - Vous ne pouvez pas placer plus de 70% de vos points sur une seule option.</p>
        <p> - Vous devez distribuer tous vos points avant de valider la distribution</p>
        <p> - La moitié des matières doivent recevoir au moins un point</p>     
      </div>
